...
#define STRING_CONFIG_H_AUTHOR "(CaptainSobe, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tevo Nereus Gold Spider"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.33, 79.02, 400, 87.96 }
